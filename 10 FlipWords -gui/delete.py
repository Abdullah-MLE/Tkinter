...
class Delete:
    ...
    def search(self):
        ...
        if word in list(word_dict["word"].values()):
            ...
            self.word_e.configure(state="disabled")
            ...
            self.search_b.configure(text="Delete", command=self.delete)
    ...
    def delete(self):
        ...
        word_dict["word"].pop(word_id)
        word_dict["ex1"].pop(word_id)
        word_dict["ex2"].pop(word_id)
        word_dict["ex3"].pop(word_id)
        word_dict["ex4"].pop(word_id)
        word_dict["ex5"].pop(word_id)
        word_dict["class"].pop(word_id)
        word_dict["state"].pop(word_id)
        word_dict["def"].pop(word_id)
